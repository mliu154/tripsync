...
export default function Home() {
  ...
  const [addUserPreviewTrip, setAddUserPreviewTrip] = useState<Trip | null>(
    null,
  );
  const [deleteCurrentUserPreviewTrip, setDeleteCurrentUserPreviewTrip] =
  ...
  const addLeg = () => {
    setNewTrip({
      ...newTrip,
      legs: [...newTrip.legs, { city: "", startDate: "", endDate: "" }],
    });
  };
  ...
  const handleAddUser = async (
    addUserTripId: string,
    username: string,
    fetchTrips: () => Promise<void>,
  ) => {
    if (!addUserTripId) return;

    await fetch(`/api/user_settings/${addUserTripId}`, {
  method: "POST",
  headers: {
  ...
  const handleDeleteCurrentUser = async (
    deleteCurrentUserTripId: string,
    fetchTrips: () => Promise<void>,
  ) => {
    if (!deleteCurrentUserTripId) return;

    await fetch(`/api/user_settings/${deleteCurrentUserTripId}`, {
      method: "DELETE",
    });
  ...
  const onEditSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    handleEditTripSubmit(e, editedTrip, fetchTrips);
  ...
  const onAddUserSelectChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const trip = trips.find((t) => t._id === id);
    if (trip) {
      setAddUserPreviewTrip(trip);
    } else {
      setAddUserPreviewTrip(null);
    }
  };
  const onDeleteCurrentUserSelectChange = (
    e: React.ChangeEvent<HTMLSelectElement>,
  ) => {
    const id = e.target.value;
    setDeleteCurrentUserTripId(id);
    const trip = trips.find((t) => t._id === id);
    if (trip) {
      setDeleteCurrentUserPreviewTrip(trip);
    } else {
      setDeleteCurrentUserPreviewTrip(null);
    }
  };
  const onAddUserSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    handleAddUser(addUserTripId, editedUser, fetchTrips);
    closeModal(addUserModalRef);
  };
  const onDeleteCurrentUserSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    handleDeleteCurrentUser(deleteCurrentUserTripId, fetchTrips);
    closeModal(deleteCurrentUserModalRef);
  };
  const onLogoutSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    handleLogout();
  };
  ...
  return (
    <div>
          ...
          <div className="modal-content">
            <form onSubmit={onEditSubmit}>
              ...
              <div className="modal-body">
                ...
                {!editedTrip && <p>Select a trip to edit.</p>}
                ...
                {editedTrip?.legs.map((leg, index) => (
                  <div key={index} className="border rounded p-3 mb-3">
                    ...
                    <input
                      ...
                      value={leg.city}
                      onChange={(e) =>
                        updateEditedLeg(index, "city", e.target.value)
                      }
                    />
                    ...
                    <input
                      ...
                      value={leg.startDate}
                      onChange={(e) =>
                        updateEditedLeg(index, "startDate", e.target.value)
                      }
                    />
                    ...
                    <input
                      ...
                      value={leg.endDate}
                      onChange={(e) =>
                        updateEditedLeg(index, "endDate", e.target.value)
                      }
                    />
                    <button
                      type="button"
          ...
          <div className="modal-content">
            <form onSubmit={onDeleteSubmit}>
              ...
              <div className="modal-body">
                ...
                {!deletePreviewTrip && <p>Select a trip to delete.</p>}
                ...
                {deletePreviewTrip?.legs.map((leg, index) => (
                  <div key={index} className="border rounded p-3 mb-3">
                    ...
                    <input
                      ...
                      disabled={true}
                      onChange={(e) =>
                        updateDeletedLeg(index, "city", e.target.value)
                      }
                    />
                    ...
                    <input
                      ...
                      disabled={true}
                      onChange={(e) =>
                        updateDeletedLeg(index, "startDate", e.target.value)
                      }
                    />
                    ...
                    <input
                      ...
                      disabled={true}
                      onChange={(e) =>
                        updateDeletedLeg(index, "endDate", e.target.value)
                      }
                    />
                  </div>
                ))}
      ...
      <div
        ...
        id="inputModal3"
        tabIndex={-1}
        aria-labelledby="inputModalLabel3"
        ref={addUserModalRef}
        aria-hidden="true"
      >
        <div className="modal-dialog">
          <div className="modal-content">
            <form onSubmit={onAddUserSubmit}>
              <div className="modal-header">
                <h5 className="modal-title" id="inputModalLabel3">
                  Add User
                </h5>
              ...
              <div className="modal-body">
                <select
                  className="form-control mb-2"
                  onChange={onAddUserSelectChange}
                  value={addUserTripId}
                >
                  <option value="">Select a Trip</option>
                ...
                {!addUserPreviewTrip && <p>Select a trip to add user.</p>}
      ...
      <div
        ...
        id="inputModal4"
        tabIndex={-1}
        aria-labelledby="inputModalLabel4"
        ref={deleteCurrentUserModalRef}
        aria-hidden="true"
      >
        <div className="modal-dialog">
          <div className="modal-content">
            <form onSubmit={onDeleteCurrentUserSubmit}>
              <div className="modal-header">
                <h5 className="modal-title" id="inputModalLabel4">
                  Delete Current User
                </h5>
              ...
              <div className="modal-body">
                <select
                  className="form-control mb-2"
                  onChange={onDeleteCurrentUserSelectChange}
                  value={deleteCurrentUserTripId}
                >
                  <option value="">Select a Trip</option>
                ...
                {!deleteCurrentUserPreviewTrip && (
                  <p>Select a trip to delete current user.</p>
                )}
              ...
              <div className="modal-footer">
                <button
                  type="submit"
                  className="btn btn-primary"
                  disabled={!deleteCurrentUserPreviewTrip}
                >
                  Delete Current User
                </button>
              </div>
